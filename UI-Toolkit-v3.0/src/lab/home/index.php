...
$html = file_get_html('./content.html');
		...
		//if(!isset($section))
			...
			if(!isset($_GET["section"])) $section = "Welcome!"; 
...
$site_url = "http://virtual-labs.ac.in/"; 
$lab_url = "http://virtual-labs.ac.in/index.php"; 
$base_url = "http://virtual-labs.ac.in/index.php"; 
