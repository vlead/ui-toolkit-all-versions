...
<head>
  ...
  <link id="size-stylesheet" rel="stylesheet" href="<?php echo $css_js;?>css/style.css"/>
  ...
  <link id="size-stylesheet1" href="<?php echo $css_js;?>css/ja.css" rel="stylesheet" >

  <!-- ***************************************************** -->
<script type='text/javascript' src='http://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js?ver=3.4'></script>
...
<!-- The lab Header contains the logo and the name of the lab,
	...
	<div id="ja-mainnav">
		<div id="ja-splitmenu" class="mainlevel clearfix">
				<ul id="main-nav-ul" > 
					<li id="menu-item1" class="menu first-item">
						<a href="<?php echo $css_js;?>./home/index.php?section=Welcome!" class="menu-item0 active first-item" id="menu1" title="Welcome!"><span class="menu-title">Welcome!</span></a></li>
					<li id="menu-item2" class="menu"><a href="<?php echo $css_js;?>./home/index.php?section=Computer Science and Engg." class="menu-item1 active" id="menu2" title="Computer Science and Engg."><span class="menu-title">Computer Science and Engg.</span></a></li>
					<li id="menu-item3" class="menu"><a href="<?php echo $css_js;?>./home/index.php?section=Chemical Sciences" class="menu-item2" id="menu3" title="Chemical Sciences"><span class="menu-title">Chemical Sciences</span></a></li>
					<li id="menu-item4" class="menu"><a href="<?php echo $css_js;?>./home/index.php?section=Civil Engg." class="menu-item3" id="menu4" title="Civil Engg."><span class="menu-title">Civil Engg.</span></a></li>
					<li id="menu-item5" class="menu"><a href="<?php echo $css_js;?>./home/index.php?section=Elec. and Comm. Engg." class="menu-item4" id="menu5" title="Elec. and Comm. Engg."><span class="menu-title">Elec. and Comm. Engg.</span></a></li>
					<li id="menu-item6" class="menu last-item"><a href="" class="menu-item5" id="menu5" title="Contact"><span class="menu-title">Contact us&nbsp;&nbsp;</span></a></li>
			...
			<ul id="experiment-article-navigation-menu">
			  ...
			  <li> tag as shown below-->
				...
				<?php foreach ($nav as $n) {?>
					...
					<li > <a class="<?php if(strcmp($section,trim($n['heading']))) echo 'a' ; else echo 'a1';?>" href="<?php echo $base_url."?section=".trim($n['heading']);?>">
...
function adjustStyle(width) {
    ...
    if (width < 1100) {
        $("#size-stylesheet").attr("href", '<?php echo $css_js;?>' + "css/style-800.css");
	$("#size-stylesheet1").attr("href", '<?php echo $css_js;?>' + "css/ja-800.css");
    } else {
        $("#size-stylesheet").attr("href", '<?php echo $css_js;?>' + "css/style.css");
	$("#size-stylesheet1").attr("href", '<?php echo $css_js;?>' + "css/ja.css");
    }
}
...
$(function() {
	...
	var pathArray = window.location.pathname.split( '/' );
	 $("#menu-item2").attr("class", "menu");
	$("#menu-item1").attr("class", "menu");
	$("#menu-item3").attr("class", "menu");
	$("#menu-item4").attr("class", "menu");
	$("#menu-item5").attr("class", "menu");
	$("#menu-item6").attr("class", "menu");
	...
	switch(pathArray[i].substring(0,3))
	{
	case "cse":
	  $("#menu-item2").attr("class", "menu active");
  	break;
	case "ccn":
	  $("#menu-item3").attr("class", "menu active");
  	break;
	case "eer":
	  $("#menu-item4").attr("class", "menu active");
  	break;
	case "~emt":
	  $("#menu-item5").attr("class", "menu active");
  	break;
	default:
	  $("#menu-item2").attr("class", "menu active");
  	break;
